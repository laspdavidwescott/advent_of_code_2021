...
def main():
    ...
    parser.add_argument("-s", "--steps", type=int, help="Number of steps to evolve", default=100)
    ...
    for step in range(args.steps):
        ...
        if args.debug:
            print("Step {} - Increase energy levels by 1".format(step + 1))
            print_data(octopus_energy_levels)
            print()
        ...
        while keep_processing:
            ...
            if args.debug and keep_processing:
                print("Step {} - Flash Propagating".format(step + 1))
                print_data(octopus_energy_levels)
                print()

        if args.debug:
            print("Step {} - Final State".format(step + 1))
            print_data(octopus_energy_levels)
            print()
    ...
    print("After {} steps, the flash count is: {}".format(args.steps, flash_count))
