...
def main():
    ...
    description = "Read in the origami instructions provided by the given file.\n" \
                  "Report the number of visible dots and resulting grid of dots."
    ...
    # If the number of folds was not given at the command line
    if args.folds == -1:
        # Update the number of folds
        args.folds = len(folds)
    ...
    print_dot_coordinates(dot_coordinates, use_dots=False)
    print()
